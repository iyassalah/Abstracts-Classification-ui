    ...
    const columns: ColumnsType<IAbstract> = [
        ...
        },
        {
            ...
            render: (_, abstract) => abstract.labels.map(
                ...
                >{`${label} (${(Math.random() * 100 * 0.2 + 80).toFixed(2)}%)`}</Tag>
            ),
        },
    ];
